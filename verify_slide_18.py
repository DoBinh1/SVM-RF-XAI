...
# The "4 bước bóc tần số lỗi" slide is Import 07/30.
# 11 template slides + 7 imported slides = 18 slides total. Index is 17.
slide_idx = 17
...
print(f"\nTotal pictures on Slide 18: {pic_count}")
if pic_count > 0:
    print("[VERIFICATION SUCCESS] The envelope comparison image was successfully compiled into Slide 18 of the PPTX file!")
else:
    print("[VERIFICATION FAILED] No pictures found on Slide 18. Please check the image extraction.")

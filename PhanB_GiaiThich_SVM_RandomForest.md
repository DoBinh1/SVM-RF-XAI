...
- **Hạn chế:** Chậm khi dữ liệu lớn (> 10,000 mẫu), đặc biệt khi dùng `probability=True` (Platt scaling dùng 5-fold CV nội bộ → ~5× chậm hơn), khó giải thích "vì sao phân loại vậy"
- **Thực tế:** SVM + RBF kernel trên CWRU cho accuracy ~82–83% với WINDOW_SIZE=16384 (sau khi envelope features được sửa chính xác)
...
- **Thực tế:** Trên CWRU với WINDOW_SIZE=16384 (envelope features chính xác), thường cho accuracy ~85–86%, tương đương hoặc tốt hơn SVM
- **Feature importance** giúp kỹ sư thấy ngay: "À, envelope features (env_energy_BPFI, kurtosis) và RMS là các chỉ số quan trọng nhất cho chẩn đoán ổ lăn"
...
|---|---|---|
| **Độ chính xác** | Cao (~82–83% trên CWRU) | Cao (~85–86% trên CWRU) |
